...
def main():
    ...
    pesanDekripsi= "EUFWQSVCENRNRIQUXFNCXUUEUSQIFFDNMLLNUSWDQCRPDAJYFOFIZTVVHHRHNTFIGNRM"
    kunci = 'MADU'
    mode1 = 'enkripsi'
    mode2 = 'dekripsi' 
...
def main():
    ...
    text = 'EUFWQSVCENRNRIQUXFNCXUUEUSQIFFDNMLLNUSWDQCRPDAJYFOFIZTVVHHRHNTFIGNRM'#Pesan yang akan di enkripsi
    key = [3, 2]
    ...
    print('Ciphertext : OKRQYENIOPBPBAYKTRPITKKOKEYARRLPMJJPKEQLYIBVLCDWRSRAZHNNXXBXPHRAUPBM')
